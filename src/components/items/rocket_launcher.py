...
class Rocket_launcher(Item):
    ...
    COMMUNE_ROCKET_LAUNCHER = ("Marseille rocket_launcher", classic_rocket_launcher, 20, 50, vec(1,8),FireballAnimation)
    RARE_ROCKET_LAUNCHER = ("terrorist rocket_launcher", silver_rocket_launcher, 50, 20, vec(1,8),FireballAnimation)
    EPIC_ROCKET_LAUNCHER = ("Kim Jon HUng rocket_launcher", golden_rocket_launcher, 100, 50, vec(1,8),FireballAnimation)
    LEGENDARY_ROCKET_LAUNCHER = ("USA rocket_launcher", bluegem_rocket_launcher, 200, 100, vec(1,8),FireballAnimation)
