...
class Potion(Item):
    ...
    ARMOR_BOOST_POTION = (("Classic Armor Potion",commune_armor,"Armor",lambda hero, m: hero.armor_boost(1.1), 10),
                          ("Rare Armor Potion",rare_armor,"Armor",lambda hero, m: hero.armor_boost(1.2), 10),
                          ("Epic Armor Potion",epic_armor,"Armor",lambda hero, m: hero.armor_boost(1.3),10),
                          ("Monstruous Armor Potion",legendary_armor,"Armor",lambda hero, m: hero.armor_boost(2),10))
    
    DAMAGE_BOOST_POTION = (("Small Damage Potion",commune_damage,"Damage",lambda hero, m: hero.damage_boost(1.2), 10, commune_damage, 1,"Increases the damages by 20% "),
                           ("Rare Damage Potion",rare_damage,"Damage",lambda hero, m: hero.damage_boost(1.2), 20, rare_damage, 1,"Increases the damages by 20%" ),
                           ("Epic Damage Potion",epic_damage,"Damage",lambda hero, m: hero.damage_boost(1.5), 20,epic_damage, 2,"Increases the damages by 50%" ),
                           ("Enormous Damage Potion",legendary_damage,"Damage",lambda hero : hero.damage_boost(2), 20,legendary_damage, 2,"Increases the damages by 100%"))
