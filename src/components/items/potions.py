...
class Potion(Item):
    ...
    #POISON_POTION = (("Commune Poison Potion",IMAGE,lambda hero : hero.poison_attack(5),1),("Rare Poison Potion",IMAGE,lambda hero : hero.poison_attack(10),1),("Epic Poison Potion",IMAGE,lambda hero : hero.poison_attack(20),1),("Legendary Poison Potion",IMAGE,lambda hero : hero.poison_attack(50),1))
    ...
    LIST = [HEALTH_POTION,ARMOR_BOOST_POTION,DAMAGE_BOOST_POTION,INVISIBILITY_POTION]#, ARMOR_BOOST_POTION,DAMAGE_BOOST_POTION,POISON_POTION,INVISIBILITY_POTION]
