...
class Potion(Item):
    ...
    HEALTH_POTION = (("PCSI Health Potion",IMAGE,"Health",lambda hero: hero.heal(5), 1) ,
                     ("Rare Health Potion",IMAGE,"Health",lambda hero: hero.heal(10), 1),
                     ("Epic Health Potion",IMAGE, "Health",lambda hero: hero.heal(20), 2),
                     ("Legendary Health Potion",IMAGE,"Health",lambda hero: hero.heal(hero.max_health), 2))
    
    ARMOR_BOOST_POTION = (("Classic Armor Potion",IMAGE,"Armor",lambda hero : hero.armor_boost(10),1),
                          ("Rare Armor Potion",IMAGE,"Armor",lambda hero : hero.armor_boost(20),1),
                          ("Epic Armor Potion",IMAGE,"Armor",lambda hero : hero.armor_boost(30),1),
                          ("Monstruous Armor Potion",IMAGE,"Armor",lambda hero : hero.armor_boost(hero.max_armor),1))
    
    DAMAGE_BOOST_POTION = (("Small Damage Potion",IMAGE,"Damage",lambda hero : hero.damage_boost(20,10)),
                           ("Rare Damage Potion",IMAGE,"Damage",lambda hero : hero.damage_boost(20,20)),
                           ("Epic Damage Potion",IMAGE,"Damage",lambda hero : hero.damage_boost(50,20)),
