...
class Sword(Item):
    ...
    COMMUNE_SWORD = ("Jesus sword", wood_sword, 5, 50, vec(1,1),10, SlashAnimation)
    RARE_SWORD = ("SEXYSEB's sword", silver_sword, 8, 20, vec(1,1),10, SlashAnimation)
    EPIC_SWORD = ("Timozob' sword", golden_sword, 10, 50, vec(1,1),20, SlashAnimation)
    LEGENDARY_SWORD = ("3 FROMAGES' Sword", diamond_sword, 15, 100, vec(1,2),50, SlashAnimation)
